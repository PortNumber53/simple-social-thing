...
ALTER TABLE public."Posts"
  RENAME COLUMN "scheduledFor" TO scheduled_for;
...
ALTER TABLE public."Posts"
  RENAME COLUMN "lastPublishJobId" TO last_publish_job_id;

ALTER TABLE public."Posts"
  RENAME COLUMN "lastPublishStatus" TO last_publish_status;

ALTER TABLE public."Posts"
  RENAME COLUMN "lastPublishError" TO last_publish_error;

ALTER TABLE public."Posts"
  RENAME COLUMN "lastPublishAttemptAt" TO last_publish_attempt_at;
