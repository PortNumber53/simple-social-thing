...
ALTER TABLE public."Posts"
  RENAME COLUMN scheduled_for TO "scheduledFor";
...
ALTER TABLE public."Posts"
  RENAME COLUMN last_publish_job_id TO "lastPublishJobId";

ALTER TABLE public."Posts"
  RENAME COLUMN last_publish_status TO "lastPublishStatus";

ALTER TABLE public."Posts"
  RENAME COLUMN last_publish_error TO "lastPublishError";

ALTER TABLE public."Posts"
  RENAME COLUMN last_publish_attempt_at TO "lastPublishAttemptAt";
