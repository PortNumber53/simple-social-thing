/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c116a0812065c9b279287dbd9c811602)
// Runtime types generated with workerd@1.20251011.0 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_GOOGLE_CLIENT_CALLBACK_URL: string;
		VITE_STRIPE_PUBLISHABLE_KEY: string;
		STRIPE_PUBLISHABLE_KEY: string;
		DATABASE_URL: string;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		VITE_WORKER_ORIGIN: string;
		VITE_DISABLE_CF_PLUGIN: string;
