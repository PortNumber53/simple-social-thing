            ...
            {user ? (
              <>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute left-0 top-full mt-0 w-48 rounded-md bg-white dark:bg-slate-900 shadow-lg ring-1 ring-black/5 dark:ring-white/10 opacity-0 pointer-events-none translate-y-0 group-hover:translate-y-2 group-hover:opacity-100 group-hover:pointer-events-auto transition duration-150">
